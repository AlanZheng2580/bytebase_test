CREATE TABLE user_test3 (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '創建時間，默認為當前時間',
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新時間，默認為當前時間並在更新時更新'
